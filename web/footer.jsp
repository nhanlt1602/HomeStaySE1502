            ...
            <div class="col-sm-6 col-md-4 p-t-50">
                ...
                <ul class="m-b-70">
                    <li class="txt14 m-b-14">
                        ...
                        75d 265, Ph??ng Hi?p Phú, Qu?n 9 , Thành Ph? H? Chí Minh
                    </li>
...
<!--===============================================================================================-->
<script type="text/javascript" src="<%= request.getContextPath()%>/vendor/daterangepicker/moment.min.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/vendor/daterangepicker/daterangepicker.js"></script>
<!--===============================================================================================-->
...
<!--===============================================================================================-->
<script type="text/javascript" src="<%= request.getContextPath()%>/vendor/parallax100/parallax100.js"></script>
...
<script type="text/javascript" src="<%= request.getContextPath()%>/js/plugins/jquery/dist/jquery.bootstrap-touchspin.js"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/js/plugins/jquery/dist/jquery.bootstrap-touchspin.min.css"></script>
<script type="text/javascript" src="<%= request.getContextPath()%>/js/plugins/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
